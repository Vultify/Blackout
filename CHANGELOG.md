...
## [4.0.0] - 2026-08-09
### Changed
- **Ported to SPT 4.1.** This version needs SPT **4.1.x** and will not run on 4.0.13 - stay on 3.1.1 for that. Same event, same Fika sync (confirmed working on player-hosted and headless raids by the 4.0.0-rc1 testers).
