...
- The Wedge himself, a solo boss holding Labs - our own bot type through MoreBotsAPI. Black Division troops come from TacticalToaster's separate BlackDiv mod, which the Wedge is set friendly toward so they hold the map together instead of fighting
...
- SAIN drives his combat: he registers under his own "Black Division" section at boss grade, with a vanilla PMC brain as the fallback when SAIN isn't installed
